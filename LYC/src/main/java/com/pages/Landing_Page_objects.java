...
public class Landing_Page_objects {
	...
	@FindBy(xpath = "//a[@id='navbarMenu']//*[text()='Sign In']")
	WebElement sign_in_top;

	@FindBy(xpath = "//div[@aria-labelledby='navbarDropdown']/a[1]")
	WebElement sign_in_top_students;

	@FindBy(xpath = "//div[@aria-labelledby='navbarDropdown']/a[2]")
	WebElement sign_in_top_school_or_consortium;

	@FindBy(xpath = "//div[@aria-labelledby='navbarDropdown']/a[3]")
	WebElement sign_in_top_employer;

	@FindBy(xpath = "//div[@aria-labelledby='navbarDropdown']/a[4]")
	...
	WebElement college_or_consortium;
	...
	public boolean validation_on_school_or_consortium_login_clickable() {
		return college_or_consortium.isEnabled();
	}
